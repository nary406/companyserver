...
const getAlldevices = async (req, res, next) => {
    const mail = [
        ...
        "rmsv34_002- Pootai", 'rmsv34_003-Siruvanthadu', "rmsv35_002- Puthirampattu", "rmsv35_003- Vadalur", "rmsv4_001- Melmalaiyanur",
    ...
    try {
        ...
        if (mail) {
            ...
            const dataCharts = Object.entries(records).map(([key, value]) => {
                ...
                const currentTime = parseInt(dateForGraphVal);
